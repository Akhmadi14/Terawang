...
const int sensor5Pin = 40;
const int sensor6Pin = 14;
const int sensor7Pin = 18;
const int sensor8Pin = 22;
...
void pengukuranSensor1() {
  ...
  if (sensor1Detected && sensor2Detected && sensor3Detected && sensor4Detected && sensor5Detected && sensor6Detected && sensor7Detected && sensor8Detected) {
    ...
    //filter nilai error ToF, hanya ToF 20>ToF<1000 yang dikirim
    if ((Tof_2 > 20 && Tof_2 < 1000) && (Tof_3 > 20 && Tof_3 < 1000) && (Tof_4 > 20 && Tof_4 < 1000) && (Tof_5 > 20 && Tof_5 < 1000) && (Tof_6 > 20 && Tof_6 < 1000) && (Tof_7 > 20 && Tof_7 < 1000) && (Tof_8 > 20 && Tof_8 < 1000)){ 
      ...
      // Tampilkan hasil ke serial monitor utk cek ToF
...
void pengukuranSensor2() {
  ...
  if (sensor1Detected && sensor2Detected && sensor3Detected && sensor4Detected && sensor5Detected && sensor6Detected && sensor7Detected && sensor8Detected) {
    ...
    //filter nilai error ToF, hanya ToF 20>ToF<1000 yang dikirim
    if((Tof_1 > 20 && Tof_1 < 1000) && (Tof_3 > 20 && Tof_3 < 1000) && (Tof_4 > 20 && Tof_4 < 1000) && (Tof_5 > 20 && Tof_5 < 1000) && (Tof_6 > 20 && Tof_6 < 1000) && (Tof_7 > 20 && Tof_7 < 1000) && (Tof_8 > 20 && Tof_8 < 1000)){
...
void pengukuranSensor3() {
  ...
  if (sensor1Detected && sensor2Detected && sensor3Detected && sensor4Detected && sensor5Detected && sensor6Detected && sensor7Detected && sensor8Detected) {
    ...
    //filter nilai error ToF, hanya ToF 20>ToF<1000 yang dikirim
    if((Tof_1 > 20 && Tof_1 < 1000) && (Tof_2 > 20 && Tof_2 < 1000) && (Tof_4 > 20 && Tof_4 < 1000) && (Tof_5 > 20 && Tof_5 < 1000) && (Tof_6 > 20 && Tof_6 < 1000) && (Tof_7 > 20 && Tof_7 < 1000) && (Tof_8 > 20 && Tof_8 < 1000)){
...
void pengukuranSensor4() {
  ...
  if (sensor1Detected && sensor2Detected && sensor3Detected && sensor4Detected && sensor5Detected && sensor6Detected && sensor7Detected && sensor8Detected) {
    ...
    //filter nilai error ToF, hanya ToF 20>ToF<1000 yang dikirim
    if((Tof_1 > 20 && Tof_1 < 1000) && (Tof_2 > 20 && Tof_2 < 1000) && (Tof_3 > 20 && Tof_3 < 1000) && (Tof_5 > 20 && Tof_5 < 1000) && (Tof_6 > 20 && Tof_6 < 1000) && (Tof_7 > 20 && Tof_7 < 1000) && (Tof_8 > 20 && Tof_8 < 1000)){
...
void pengukuranSensor5() {
  ...
  if (sensor1Detected && sensor2Detected && sensor3Detected && sensor4Detected && sensor5Detected && sensor6Detected && sensor7Detected && sensor8Detected) {
    ...
    //filter nilai error ToF, hanya ToF 20>ToF<1000 yang dikirim
    if((Tof_1 > 20 && Tof_1 < 1000) && (Tof_2 > 20 && Tof_2 < 1000) && (Tof_3 > 20 && Tof_3 < 1000) && (Tof_4 > 20 && Tof_4 < 1000) && (Tof_6 > 20 && Tof_6 < 1000) && (Tof_7 > 20 && Tof_7 < 1000) && (Tof_8 > 20 && Tof_8 < 1000)){
...
void pengukuranSensor6() {
  ...
  if (sensor1Detected && sensor2Detected && sensor3Detected && sensor4Detected && sensor5Detected && sensor6Detected && sensor7Detected && sensor8Detected) {
    ...
    //filter nilai error ToF, hanya ToF 20>ToF<1000 yang dikirim
    if((Tof_1 > 20 && Tof_1 < 1000) && (Tof_2 > 20 && Tof_2 < 1000) && (Tof_3 > 20 && Tof_3 < 1000) && (Tof_4 > 20 && Tof_4 < 1000) && (Tof_5 > 20 && Tof_5 < 1000) && (Tof_7 > 20 && Tof_7 < 1000) && (Tof_8 > 20 && Tof_8 < 1000)){
...
void pengukuranSensor7() {
  ...
  if (sensor1Detected && sensor2Detected && sensor3Detected && sensor4Detected && sensor5Detected && sensor6Detected && sensor7Detected && sensor8Detected) {
    ...
    //filter nilai error ToF, hanya ToF 20>ToF<1000 yang dikirim
    if((Tof_1 > 20 && Tof_1 < 1000) && (Tof_2 > 20 && Tof_2 < 1000) && (Tof_3 > 20 && Tof_3 < 1000) && (Tof_4 > 20 && Tof_4 < 1000) && (Tof_5 > 20 && Tof_5 < 1000) && (Tof_6 > 20 && Tof_6 < 1000) && (Tof_8 > 20 && Tof_8 < 1000)){
...
void pengukuranSensor8() {
  ...
  if (sensor1Detected && sensor2Detected && sensor3Detected && sensor4Detected && sensor5Detected && sensor6Detected && sensor7Detected && sensor8Detected) {
    ...
    //filter nilai error ToF, hanya ToF 20>ToF<1000 yang dikirim
    if((Tof_1 > 20 && Tof_1 < 1000) && (Tof_2 > 20 && Tof_2 < 1000) && (Tof_3 > 20 && Tof_3 < 1000) && (Tof_4 > 20 && Tof_4 < 1000) && (Tof_5 > 20 && Tof_5 < 1000) && (Tof_6 > 20 && Tof_6 < 1000) && (Tof_7 > 20 && Tof_7 < 1000)){
